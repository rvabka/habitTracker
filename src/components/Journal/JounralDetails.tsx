      ...
      {filteredHabits.length > 0 ? (
        filteredHabits.map((item, index: number) => {
          ...
          return (
            <div
              key={item.id}
              className="flex w-full items-center justify-around overflow-y-auto border-y-[0.1rem] border-y-second p-2 py-4"
            >
              ...
              <div>
                <button
                  ...
                  onClick={() => handleChangeCount(item.id, item.presentCount)}
                >
